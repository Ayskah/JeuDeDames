...
/**
 * @author ayskaw
 * Singleton GameBoard. Sets the X, Y from the GameBoard, sets an unique Parser.
 * @see Parser
 */
public class Board{
	...
	/**
	 * @return plat Singleton instance of a GameBoard
	 */
	...
	/**
	 * @return theParser The parser associated with this GameBoard
	 */
	public Parser getParser(){
		return theParser;
	}
	/**
	 * @param myNick Set the nick of the player associated with this GUI
	 */
	public void setNick(String myNick){
		this.myNick=myNick;
	}
	/**
	 * @return myNick Get the nick of the player associated with this GUI
	 */
